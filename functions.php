...
function bb_setup() {
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'bigbang' ),
	) );
...
function bb_scripts() {
	...
	wp_enqueue_script( 'bigbang-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true ); // TODO: fix paths

	wp_enqueue_script( 'bigbang-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true ); // TODO: fix paths
