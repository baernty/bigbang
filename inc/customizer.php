...
function bb_customize_preview_js() {
	wp_enqueue_script( 'bb_customizer', get_template_directory_uri() . '/assets/src/js/customizer.js', array( 'customize-preview' ), '20130508', true ); // TODO: fix paths
}
